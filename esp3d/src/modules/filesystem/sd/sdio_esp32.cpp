...
bool ESP_SD::begin()
{
    ...
    pinMode(ESP_SDIO_CMD_PIN, INPUT_PULLUP);
    pinMode(ESP_SDIO_D0_PIN, INPUT_PULLUP);
    pinMode(ESP_SDIO_D1_PIN, INPUT_PULLUP);
    pinMode(ESP_SDIO_D2_PIN, INPUT_PULLUP);
    pinMode(ESP_SDIO_D3_PIN, INPUT_PULLUP);
